...
const MaterialUISwitch = (0, styles_1.styled)(Switch_1.default)(({ theme }) => ({
    width: 62,
    height: 34,
    padding: 7,
...
const Android12Switch = (0, styles_1.styled)(Switch_1.default)(({ theme }) => ({
    padding: 8,
    "& .MuiSwitch-track": {
        borderRadius: 22 / 2,
        "&:before, &:after": {
...
const IOSSwitch = (0, styles_1.styled)((props) => (<Switch_1.default focusVisibleClassName=".Mui-focusVisible" disableRipple {...props}/>))(({ theme }) => ({
    width: 42,
    height: 26,
    padding: 0,
    "& .MuiSwitch-switchBase": {
...
const AntSwitch = (0, styles_1.styled)(Switch_1.default)(({ theme }) => ({
    width: 28,
    height: 16,
    padding: 0,
    display: "flex",
...
function CustomizedSwitches() {
    return (<FormGroup_1.default>
      <FormControlLabel_1.default control={<IOSSwitch sx={{ m: 1 }} defaultChecked/>}/>
    </FormGroup_1.default>);
}
exports.default = CustomizedSwitches;
